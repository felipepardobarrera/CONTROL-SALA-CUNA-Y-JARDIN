...
const STORAGE_NAMESPACE = "control-bienestar-2026-v2";
const STORAGE_KEY = `${STORAGE_NAMESPACE}-gastos`;
const PROJECTION_KEY = `${STORAGE_NAMESPACE}-proyecciones`;
const PROJECTION_GRID_KEY = `${STORAGE_NAMESPACE}-proyeccion-mensual`;
const PROJECTION_PAID_KEY = `${STORAGE_NAMESPACE}-proyeccion-pagado`;
const PROVIDER_KEY = `${STORAGE_NAMESPACE}-proveedores`;
const BUDGET_KEY = `${STORAGE_NAMESPACE}-presupuesto-base`;
const COLLAPSE_KEY = `${STORAGE_NAMESPACE}-paneles`;
const STATIC_DATA_VERSION_KEY = `${STORAGE_NAMESPACE}-datos-publicados`;
const NO_PAYMENT_KEY = `${STORAGE_NAMESPACE}-sin-pago-mensual`;
const EXPENSE_DISCLOSURE_KEY = `${STORAGE_NAMESPACE}-despliegue-pagos`;
const DISMISSED_ALERTS_KEY = `${STORAGE_NAMESPACE}-alertas-ocultas`;
const DELETED_PROVIDERS_KEY = `${STORAGE_NAMESPACE}-proveedores-eliminados`;
...
function openAttachmentDatabase() {
  return new Promise((resolve, reject) => {
    const request = indexedDB.open("control-bienestar-2026-documentos-v2", 1);
